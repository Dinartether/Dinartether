...
"""
Dinartether test framework primitive and message structures.
...
COIN = 100000000  # 1 dint in Corbies
...
class CAddress:
    """
    Objects that map to dinartetherd objects, which can be serialized/deserialized
    """
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in dinartetherd
            if flags != 0:
                self.vin = deser_vector(f, CTxIn)
...
class MsgHeaders:
    ...
    def deserialize(self, f):
        # comment in dinartetherd indicates these should be deserialized as blocks
