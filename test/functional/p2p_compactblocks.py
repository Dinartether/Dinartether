...
# TestNode: A peer we use to send messages to dinartetherd, and store responses.
...
class CompactBlocksTest(DinartetherTestFramework):
    ...
    # This test actually causes dinartetherd to (reasonably!) disconnect us, so do this last.
    ...
    # dinartetherd's choice of nonce.
    ...
    # Test that dinartetherd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for dinartetherd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # dinartetherd will not send blocktxn responses for blocks whose height is
