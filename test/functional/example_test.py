...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the DinartetherTestFramework
    pass

class ExampleTest(DinartetherTestFramework):
    # Each functional test is a subclass of the DinartetherTestFramework class.
    ...
    def custom_method(self):
        ...
        DinartetherTestFramework class so other tests can use it."""
