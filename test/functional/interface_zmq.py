...
import os
import struct
from test_framework.test_framework import DinartetherTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(DinartetherTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that dinartether has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("dinartetherd has not been built with zmq enabled.")
