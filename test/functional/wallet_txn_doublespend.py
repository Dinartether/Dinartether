...
class TxnMallTest(DinartetherTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 DINT:
        ...
        # First: use raw transaction API to send 1240 DINT to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 DINT coin each
        ...
        # Node0's balance should be starting balance, plus 50DINT for another
        ...
        # Node0's total balance should be starting balance, plus 100DINT for 
