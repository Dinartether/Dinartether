...
class AssetTest(DinartetherTestFramework):
    ...
    def big_test(self):
        ...
        n0.listassets(asset="DINT*", verbose=False, count=2, start=-2)
        ...
        dinartether_assets = n0.listassets(asset="DINT*", verbose=False, count=2, start=-2)
        assert_equal(len(dinartether_assets), 2)
        assert_equal(dinartether_assets[0], "DINT2")
        assert_equal(dinartether_assets[1], "DINT3")
        self.sync_all()
