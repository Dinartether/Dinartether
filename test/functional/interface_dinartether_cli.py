...
class TestDinartetherCli(DinartetherTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `dinartether-cli getinfo`")
        ...
        self.log.info("Compare responses from `dinartether-cli -getinfo` and the RPCs data is retrieved from.")
