...
class BIP66Test(DinartetherTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # dinartetherd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and dinartetherd produces more specific reject
            # reasons.
