...
By default, dinartetherd will dump mempool on shutdown and
...
class MempoolPersistTest(DinartetherTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give dinartetherd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent dinartetherd from writing mempool.dat to disk. Verify that `savemempool` fails")
