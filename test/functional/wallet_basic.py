...
class WalletTest(DinartetherTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 DINT from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 DINT with subtract fee from amount
        ...
        # Sendmany 10 DINT with subtract fee from amount
