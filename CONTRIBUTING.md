Contributing to Dinartether Core
============================

The Dinartether Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *GUI* for changes to dinartether-qt
  - *Mining* for changes to the mining code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST/ZMQ* for changes to the RPC, REST or ZMQ APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the dinartether unit tests or QA tests
...
The following applies to code changes to the Dinartether project (and related
projects) and is not to be confused with overall Dinartether
Network Protocol consensus changes.

Whether a pull request is merged into Dinartether rests with the project merge
...
Patches that change Dinartether consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dinartether consensus, it must have been
...
The DinartetherQT-SIG selects a release manager for each Dinartether release.
