...
#Set this to your dinartether-cli program
cli = "dinartether-cli"

#mode = "-testnet"
mode = ""
rpc_port = 12021
#Set this information in your dinartether.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
	...
	for i in range(start_block,blockheight):
	    ...
	    for tx in txs:
	        ...
	        for vout in tx_detail.get('vout'):
	            if (vout.get('scriptPubKey').get('asm')[86:98] == "OP_DINARTETHER_ASSET"):
	                print_debug("Found OP_DINARTETHER_ASSET")
	...
	while True:
		...
		if topic == b"hashblock":
			...
			#print(vout.get('scriptPubKey').get('asm'))
				if (vout.get('scriptPubKey').get('asm')[86:98] == "OP_DINARTETHER_ASSET"):
					#print("Found OP_DINARTETHER_ASSET")
