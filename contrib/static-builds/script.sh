...
rm -rf ~/dinartether ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../dinartether/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../dinartether/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/dinartether/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/dinartether/depends/SDKs/MacOSX10.11.sdk.tar.gz
