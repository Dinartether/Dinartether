...
#ifndef DINARTETHER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define DINARTETHER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // DINARTETHER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
