...
#ifndef DINARTETHER_VALIDATION_H
#define DINARTETHER_VALIDATION_H
...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 10 min) */ // TODO Should we change this for dinartether, with 1 minutes block intervals?
...
#endif // DINARTETHER_VALIDATION_H
