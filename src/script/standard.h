...
#ifndef DINARTETHER_SCRIPT_STANDARD_H
#define DINARTETHER_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_DINARTETHER_ASSET script that carries data
    /** DINT END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a dinartether address
 */
...
/**
 * Generate a Dinartether scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // DINARTETHER_SCRIPT_STANDARD_H
