...
#ifndef DINARTETHER_SCRIPT_SCRIPT_H
#define DINARTETHER_SCRIPT_SCRIPT_H
...
public:
    ...
    bool GetOp2(const_iterator& pc, opcodetype& opcodeRet, std::vector<unsigned char>* pvchRet) const
    {
        ...
        // If we see an op dint asset, we consider all data after it has data, and not op codes
        // Move the pc to the end of the script
        if (opcode == OP_DINARTETHER_ASSET) {
    ...
    /**
     * Pre-version-0.6, Dinartether always counted CHECKMULTISIGs
...
#endif // DINARTETHER_SCRIPT_SCRIPT_H
