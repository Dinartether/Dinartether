...
BOOST_FIXTURE_TEST_SUITE(netbase_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(netbase_splithost_test)
    {
        ...
        BOOST_CHECK(TestSplitHost("www.dinartether.org", "www.dinartether.org", -1));
        BOOST_CHECK(TestSplitHost("[www.dinartether.org]", "www.dinartether.org", -1));
        BOOST_CHECK(TestSplitHost("www.dinartether.org:80", "www.dinartether.org", 80));
        BOOST_CHECK(TestSplitHost("[www.dinartether.org]:80", "www.dinartether.org", 80));
        BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
        BOOST_CHECK(TestSplitHost("127.0.0.1:12022", "127.0.0.1", 12022));
        BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
        BOOST_CHECK(TestSplitHost("[127.0.0.1]:12022", "127.0.0.1", 12022));
        BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
        BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:12022", "::ffff:127.0.0.1", 12022));
        BOOST_CHECK(TestSplitHost("[::]:12022", "::", 12022));
        BOOST_CHECK(TestSplitHost("::12022", "::12022", -1));
        BOOST_CHECK(TestSplitHost(":12022", "", 12022));
        BOOST_CHECK(TestSplitHost("[]:12022", "", 12022));
    ...
    BOOST_AUTO_TEST_CASE(netbase_lookupnumeric_test)
    {
        ...
        BOOST_CHECK(TestParse("127.0.0.1:12022", "127.0.0.1:12022"));
        BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
        BOOST_CHECK(TestParse("::", "[::]:65535"));
        BOOST_CHECK(TestParse("[::]:12022", "[::]:12022"));
        BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
