...
#ifndef DINARTETHER_TEST_SCRIPTNUM10_H
#define DINARTETHER_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Dinartether Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // DINARTETHER_TEST_BIGNUM_H
