...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler dint tx
        CScript dintTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut dintOut(1*COIN, dintTransfer);
        ...
        mutTxTest1.vout.emplace_back(dintOut);
        ...
        mutTxTest2.vout.emplace_back(dintOut);
        ...
        mutTxTest3.vout.emplace_back(dintOut);
        ...
        mutTxTest4.vout.emplace_back(dintOut);
        ...
        mutTxTest5.vout.emplace_back(dintOut);
        ...
        mutTxTest6.vout.emplace_back(dintOut);
        ...
        mutTxTest7.vout.emplace_back(dintOut);
        ...
        mutTxTest8.vout.emplace_back(dintOut);
