 ...
 */
#ifndef DINARTETHER_UTIL_H
#define DINARTETHER_UTIL_H
...
extern const char *const DINARTETHER_CONF_FILENAME;
extern const char *const DINARTETHER_PID_FILENAME;
...
{
    std::string s = strprintf("dinartether-%s", name);
