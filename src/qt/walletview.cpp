...
void WalletView::setDinartetherGUI(DinartetherGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? DinartetherGUI::HD44_ENABLED : _walletModel->hdEnabled() ? DinartetherGUI::HD_ENABLED : DinartetherGUI::HD_DISABLED);
