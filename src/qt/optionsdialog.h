...
#ifndef DINARTETHER_QT_OPTIONSDIALOG_H
#define DINARTETHER_QT_OPTIONSDIALOG_H
...
private Q_SLOTS:
    ...
    void on_openDinartetherConfButton_clicked();
...
#endif // DINARTETHER_QT_OPTIONSDIALOG_H
