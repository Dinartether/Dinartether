...
#include "qt/dinartetheramountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<DinartetherAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_dinartether-qt -platform xcb      # Linux
//     src/qt/test/test_dinartether-qt -platform windows  # Windows
//     src/qt/test/test_dinartether-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = DinartetherUnits::formatWithUnit(unit, balance, false, DinartetherUnits::separatorAlways);
    ...
    // Amount input
    DinartetherAmountField* amountInput = receiveCoinsDialog.findChild<DinartetherAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: dinartether:")) != -1);
