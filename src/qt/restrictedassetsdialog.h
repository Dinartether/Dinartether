...
#ifndef DINARTETHER_QT_RESTRICTEDASSETSDIALOG_H
#define DINARTETHER_QT_RESTRICTEDASSETSDIALOG_H
...
/** Dialog for sending dinartethers */
...
#endif // DINARTETHER_QT_RESTRICTEDASSETSSDIALOG_H
