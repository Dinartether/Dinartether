...
#ifndef DINARTETHER_QT_GUIUTIL_H
#define DINARTETHER_QT_GUIUTIL_H
...
/** Utility functions used by the Dinartether Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "dinartether:" URI into recipient object, return true on successful parsing
...
#endif // DINARTETHER_QT_GUIUTIL_H
