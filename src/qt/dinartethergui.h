...
#ifndef DINARTETHER_QT_DINTGUI_H
#define DINARTETHER_QT_DINTGUI_H
...
/**
  Dinartether GUI main class. This class represents the main window of the Dinartether UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DinartetherGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit DinartetherGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~DinartetherGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a dinartether wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // DINARTETHER_QT_DINTGUI_H
