    ...
    mapper(0)
{
    ...
    ui->dinartetherAtStartup->setToolTip(ui->dinartetherAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->dinartetherAtStartup->setText(ui->dinartetherAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openDinartetherConfButton->setToolTip(ui->openDinartetherConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new DinartetherUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->dinartetherAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openDinartetherConfButton_clicked()
{
    ...
    if (!GUIUtil::openDinartetherConf())
