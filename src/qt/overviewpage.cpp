...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(DinartetherUnits::DINT),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->dintBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->dintBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(DinartetherUnits::formatWithUnit(unit, balance, false, DinartetherUnits::separatorAlways));
    ui->labelUnconfirmed->setText(DinartetherUnits::formatWithUnit(unit, unconfirmedBalance, false, DinartetherUnits::separatorAlways));
    ui->labelImmature->setText(DinartetherUnits::formatWithUnit(unit, immatureBalance, false, DinartetherUnits::separatorAlways));
    ui->labelTotal->setText(DinartetherUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, DinartetherUnits::separatorAlways));
    ui->labelWatchAvailable->setText(DinartetherUnits::formatWithUnit(unit, watchOnlyBalance, false, DinartetherUnits::separatorAlways));
    ui->labelWatchPending->setText(DinartetherUnits::formatWithUnit(unit, watchUnconfBalance, false, DinartetherUnits::separatorAlways));
    ui->labelWatchImmature->setText(DinartetherUnits::formatWithUnit(unit, watchImmatureBalance, false, DinartetherUnits::separatorAlways));
    ui->labelWatchTotal->setText(DinartetherUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, DinartetherUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("DINT")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the DINT balance grid from expanding and looking terrible when asset balance is hidden
