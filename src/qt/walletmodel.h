...
#ifndef DINARTETHER_QT_WALLETMODEL_H
#define DINARTETHER_QT_WALLETMODEL_H
...
/** Interface to Dinartether wallet from Qt view code. */
...
#endif // DINARTETHER_QT_WALLETMODEL_H
