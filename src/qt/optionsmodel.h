...
#ifndef DINARTETHER_QT_OPTIONSMODEL_H
#define DINARTETHER_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Dinartether client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // DinartetherUnits::Unit
...
#endif // DINARTETHER_QT_OPTIONSMODEL_H
