...
#ifndef DINARTETHER_QT_GUICONSTANTS_H
#define DINARTETHER_QT_GUICONSTANTS_H
...
/* DinartetherGUI -- Size of icons in status bar */
...
/* Dinartether label color as a string */
...
#define QAPP_ORG_NAME "Dinartether"
#define QAPP_ORG_DOMAIN "dinartether.org"
#define QAPP_APP_NAME_DEFAULT "Dinartether-Qt"
#define QAPP_APP_NAME_TESTNET "Dinartether-Qt-testnet"

/* Default third party browser urls */
#define DEFAULT_THIRD_PARTY_BROWSERS "https://api.dinartether.com/tx/%s|https://dint.cryptoscope.io/tx/?txid=%s|https://blockbook.dinartether.com/tx/%s|https://explorer.mangofarmassets.com/tx/%s|https://www.assetsexplorer.com/tx/%s|https://explorer.dinartether.com/tx/%s"

/* Default IPFS viewer */
#define DEFAULT_IPFS_VIEWER "https://ipfs.io/ipfs/%s"

#endif // DINARTETHER_QT_GUICONSTANTS_H
