...
#ifndef DINARTETHER_QT_SENDASSETSENTRY_H
#define DINARTETHER_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending dinartethers.
...
#endif // DINARTETHER_QT_SENDASSETSENTRY_H
