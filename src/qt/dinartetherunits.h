...
#ifndef DINARTETHER_QT_DINTUNITS_H
#define DINARTETHER_QT_DINTUNITS_H
...
/** Dinartether unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DinartetherUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DinartetherUnits(QObject *parent);
...
typedef DinartetherUnits::Unit DinartetherUnit;

#endif // DINARTETHER_QT_DINTUNITS_H
