...
#ifndef DINARTETHER_CHAINPARAMS_H
#define DINARTETHER_CHAINPARAMS_H
 ...
 * Dinartether system. There are three: the main network on which people trade goods
...
#endif // DINARTETHER_CHAINPARAMS_H
