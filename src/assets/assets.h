...
#ifndef DINARTETHER_ASSET_PROTOCOL_H
#define DINARTETHER_ASSET_PROTOCOL_H
...
#define DINARTETHER_R 114
#define DINARTETHER_V 118
#define DINARTETHER_N 110
#define DINARTETHER_Q 113
#define DINARTETHER_T 116
#define DINARTETHER_O 111
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_DINARTETHER_ASSET DINTQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_DINARTETHER_ASSET DINTO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_DINARTETHER_ASSET DINTR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_DINARTETHER_ASSET DINTT
...
#endif //DINARTETHER_ASSET_PROTOCOL_H
