...
Below are some notes on how to build Dinartether Core for Windows.
...
way. This will install to `c:\workspace\dinartether`, for example:

    make install DESTDIR=/mnt/c/workspace/dinartether
