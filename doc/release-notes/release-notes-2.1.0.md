Dinartether Core version *2.1.0* is now available!!
==============

  <https://github.com/Dinartether/Dinartether/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/Dinartether/Dinartether/commits/release_2.1.0>
