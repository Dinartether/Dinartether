Dinartether Core version *2.0.4.0* is now available!!
==============

  <https://github.com/Dinartether/Dinartether/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/Dinartether/Dinartether/commits/release_2.0.4>
