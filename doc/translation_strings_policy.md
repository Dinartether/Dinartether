...
This document provides guidelines for internationalization of the Dinartether Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `dinartether_en.ts` remains unchanged.
